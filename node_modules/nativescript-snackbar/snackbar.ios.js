...
var SnackBar = (function () {
    ...
    SnackBar.prototype.simple = function (snackText) {
        ...
        return new Promise(function (resolve, reject) {
            var timeout = 3;
            try {
                _this._snackbar = SSSnackbar.snackbarWithMessageActionTextDurationActionBlockDismissalBlock(snackText, _this._getActionText(), timeout, function (args) {
    ...
    SnackBar.prototype.getSnackbar = function () {
        return this._snackbar;
    };
    SnackBar.prototype._getActionText = function () {
        var bundle = (typeof NSBundle.mainBundle === 'function') ? NSBundle.mainBundle() : NSBundle.mainBundle;
